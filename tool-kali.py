...
def termux_libs_down() :
	os.system(pkg_install + "git -y")
	os.system(pkg_install + " curl -y")
	os.system(pkg_install + " wget -y")
	os.system(pkg_install + " python -y")
	os.system(pkg_install + " python3 -y")
	os.system(pkg_install + " python2 -y")
	os.system(pkg_install + " php -y")
	os.system(pkg_install + " perl -y")
	os.system(pkg_install + " nano -y")
	os.system(pkg_install + " vim -y")
	os.system(pkg_install + " cat -y")
	os.system(pkg_install + " pip -y")
	os.system(pkg_install + " pip2 -y")
	os.system(pkg_install + " nmap -y")
	os.system(pkg_install + " hydra -y")
	os.system(pkg_install + " ruby -y")
	os.system("pip install wordlist -y")
	os.system("gem install bundle -y")
	os.system(pkg_install + " tsu -y")
...
os.system("clear")
os.system(pkg_install + " figlet -y")
os.system(pkg_install + " toilet -y")
os.system("clear")
loading_screen(2)
startscreen_menu()
