...
def termux_libs_down() :
	os.system(f"{pkg_install} git -y")
	os.system(f"{pkg_install} curl -y")
	os.system(f"{pkg_install} wget -y")
	os.system(f"{pkg_install} python -y")
	os.system(f"{pkg_install} python3 -y")
	os.system(f"{pkg_install} python2 -y")
	os.system(f"{pkg_install} php -y")
	os.system(f"{pkg_install} perl -y")
	os.system(f"{pkg_install} nano -y")
	os.system(f"{pkg_install} vim -y")
	os.system(f"{pkg_install} cat -y")
	os.system(f"{pkg_install} pip -y")
	os.system(f"{pkg_install} pip2 -y")
	os.system(f"{pkg_install} nmap -y")
	os.system(f"{pkg_install} hydra -y")
	os.system(f"{pkg_install} ruby -y")
	os.system("pip install wordlist -y")
	os.system("gem install bundle -y")
	os.system(f"{pkg_install} tsu -y")
...
[4] Write your name big and colorful
		...
		os.system(f"{pkg_install} fakeroot")
		os.system("fakeroot")
		os.system("clear")
...
os.system("clear")
os.system(f"{pkg_install} figlet -y")
os.system(f"{pkg_install} toilet -y")
os.system("clear")
loading_screen(2)
startscreen_menu()
